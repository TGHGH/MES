...
namespace Producing
{
    public partial class ModuleClean : Form
    {
        ...
        string _currentModuleId = string.Empty;
        #endregion
        ...
        void cbx_workshop_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            lstInputParas.Add(BasicClass.comoboxItemName.CleanEqp);
        ...
        void tbx_module_id_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                _currentModuleId = tbx_module_id.Text.Trim().ToUpper();
        ...
        private void btn_ok_Click(object sender, EventArgs e)
        {
            ...
            functionTag.FuncName = "InsertModuleCleanInfo";
            functionTag.InputParams = inParameters.ToArray();

            WcfRequests.SendGeneralRequest(onInsertModuleCleanInfoReceived, functionTag);
        }
